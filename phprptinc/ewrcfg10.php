...
define("EWR_PROJECT_ID", "{7137060F-07C2-4A35-A0C6-B1239DE3EB7E}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "WOM", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "166.62.96.123", "port" => 3306, "user" => "arquitec_wom", "pass" => "a7xR4enGFEqcwh2d", "db" => "arquitec_wom", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'wW9SFxy1MXSwtEdA', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/WOM.css", TRUE); // Project stylesheet file name
